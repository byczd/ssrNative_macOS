 ...
 *  SSL 3.0规范由Netscape于1996年起草，并于1999年成为IETF标准
 *  http://wp.netscape.com/eng/ssl3/
 *  http://www.ietf.org/rfc/rfc2246.txt
 *  http://www.ietf.org/rfc/rfc4346.txt
 *
 *  TLS是 IETF 在 SSL 3.0 的基础上设计的协议，它是 SSL 协议的升级版。两者差别极小，可以理解为 TLS 是 SSL 3.1(可简单理解为同一事物不同阶段的不同称呼)
...
/*
 * Receive application data decrypted from the SSL layer 接收从SSL层解密的应用程序数据
 */
