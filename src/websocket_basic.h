...
uint8_t * websocket_connect_request_Ex(const char *ws_host,const char *ws_path,const char *server_host, uint16_t server_port,
                                       const char *key, void*(*allocator)(size_t), size_t *result_len); //add.by.adong
...
uint8_t * websocket_build_frame_with_mask0(ws_frame_info *info, const uint8_t *payload, size_t payload_len, void*(*allocator)(size_t)); //add.by.adong
